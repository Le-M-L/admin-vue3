        ...
        <div class="hidden xl:flex xl:flex-col xl:w-6/12 min-h-full mr-4 pl-4">
          ...
          <div class="my-auto">
            ...
            <div class="mt-10 font-medium text-white -enter-x">
              <span class="mt-4 text-3xl inline-block"> signInTitle</span>
            </div>
...
<script>
  ...
  import { AppLocalePicker } from '@/components/comps/Application';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      return {
        ...
        showLocale: store.getters['locale/getShowPicker'],
      };
    },
  });
</script>
