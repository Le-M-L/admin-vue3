    ...
    <transition name="fade-slide">
      <div :class="`${prefixCls}-entry`" v-show="!showDate">
        <div :class="`${prefixCls}-entry-content`">
          ...
          <InputPassword placeholder="placeholder" class="enter-x" v-model:value="password" />
          <span :class="`${prefixCls}-entry__err-msg enter-x`" v-if="errMsgRef"> alert </span>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const realName = computed(() => {
        const { realName } = store.getters['user/getUserInfoState'];
        return realName;
      });
      ...
      async function unLock() {
        ...
        try {
          ...
          const res = await store.dispatch('lock/unLockAction', { password });
          errMsgRef.value = !res;
        } finally {
      ...
      function goLogin() {
        ...
        store.dispatch('lock/resetLockInfo');
      }
