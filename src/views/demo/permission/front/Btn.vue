...
<script>
  ...
  import { Authority } from '@/components/comps/Authority';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      return {
        userName: store.getters['user/getRoleListState'],
        RoleEnum,
        isSuper: computed(() => store.getters['user/getRoleListState'].includes(RoleEnum.SUPER)),
        isTest: computed(() => store.getters['user/getRoleListState'].includes(RoleEnum.TEST)),
        changeRole,
        hasPermission,
      };
    },
