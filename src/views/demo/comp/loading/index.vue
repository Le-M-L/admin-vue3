<template>
  <PageWrapper v-loading="loadingRef" loading-tip="加载中..." title="Loading组件示例">
    ...
    <!-- 代码示例 -->
    <ExampleCode class="mb-4" :html="instructionHtml" />
...
<script>
  ...
  import { Loading, useLoading } from '@/components/comps/Loading';
  import { PageWrapper } from '@/components/comps/Page';
  import { Alert } from 'ant-design-vue';
  import ExampleCode from '@/components/exampleCode';
  import PropsTable from '@/components/PropsTable.vue';
  import { propsData, baseHtml, funHtml, instructionHtml } from './data';
  export default defineComponent({
    components: { Loading, PageWrapper, [Alert.name]: Alert, ExampleCode, PropsTable },
    setup() {
