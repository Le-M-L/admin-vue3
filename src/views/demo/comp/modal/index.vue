<template>
  <PageWrapper title="modal组件使用示例">
    ...
    <!-- 示列说明 -->
    <ExampleCode title="useModalInner 说明" :html="useModalInnerHtml" />
    ...
    <PropsTable
      ...
      :propsData="propsData"
      :eventData="eventData"
      link="https://2x.antdv.com/components/modal-cn/#API"
    />
  </PageWrapper>
</template>
<script>
  ...
  import { propsData, baseHtml, eventData, useModalInnerHtml } from './data';
  export default defineComponent({
    components: { Alert, Modal1, Modal2, Modal3, Modal4, PageWrapper, ExampleCode, PropsTable },
    setup() {
