...
<script>
  ...
  import { SimpleMenuTag } from '@/components/comps/SimpleMenu';
  ...
  import { SIDE_BAR_SHOW_TIT_MINI_WIDTH, SIDE_BAR_MINI_WIDTH } from '@/config/enums/appEnum';

  import clickOutside from '@/config/directives/clickOutside';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function hanldeModuleClick(path, hover = false) {
